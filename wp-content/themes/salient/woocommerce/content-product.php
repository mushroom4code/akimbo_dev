...
$preorder = 0;
$is_upcoming = 0;
$isset_img = $product->get_image_id();
$productPrice = $product->get_price();
$productQuantity = $product->get_stock_quantity();
$productIsBackOrder = $product->get_backorders();
...
if(empty($isset_img) || ($productQuantity <= 0  && $productIsBackOrder !== 'yes' && !$preorder &&  !$is_upcoming)  ){
    return;
}
