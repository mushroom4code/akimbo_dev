	...
	<div class="container main-content">
		...
		<div class="row">
			...
			<div class="col span_12">
				...
				<br /><br /><h4 style="text-align: center;">Компания АКИМБО выпускает и продает оптом дизайнерскую одежду <br />в <em>нео</em>классическом стиле для истинных леди</h4>
				<a class="nectar-button large regular-button accent-color" data-color-override="false" data-hover-color-override="false" href="http://akimbo-moda.ru/shop/" style="visibility: visible;"><span>Оптовый каталог AKIMBO</span></a>
				 &nbsp; &nbsp;
