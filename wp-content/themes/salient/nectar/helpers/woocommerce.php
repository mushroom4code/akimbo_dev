...
if ( $product_style == 'classic' ) {
    ...
    add_action( 'woocommerce_before_shop_loop_item_title', 'product_thumbnail_slick_slider', 10 );
...
if ( ! function_exists( 'product_thumbnail_slick_slider' ) ) {

    function product_thumbnail_slick_slider() {
