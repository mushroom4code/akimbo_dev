...
function nectar_portfolio_processing($atts, $content = null)
{
    ...
    if($enable_sortable == 'true' && $horizontal_filters == 'true') {
        ...
        ?>
        <div class="<?php echo esc_attr($filters_id) . ' ';
        echo esc_attr($filters_width);
        if($layout == 'constrained_fullwidth') echo ' fullwidth-constrained ';
        if($span_num != 'elastic-portfolio-item' || $layout == 'constrained_fullwidth') echo 'non-fw'; ?>"
             data-alignment="<?php echo esc_attr($filter_alignment); ?>"
             data-color-scheme="<?php echo strtolower(esc_attr($filter_color)); ?>">
            <div class="container <?php if($span_num == 'elastic-portfolio-item') {
                echo 'normal-container';
            } ?>">
                <?php if($filter_alignment != 'center' && $filter_alignment != 'left') { ?> <span
                        id="current-category"><?php echo esc_html__('All', 'salient'); ?></span> <?php } ?>
                <ul>
                    <?php if($filter_alignment != 'center' && $filter_alignment != 'left') { ?>
                        <li id="sort-label"><?php echo (!empty($nectar_options['portfolio-sortable-text'])) ? $nectar_options['portfolio-sortable-text'] : esc_html__('Sort Portfolio', 'salient'); ?>
                            :
                        </li> <?php } ?>
    ...
    <?php } else if($enable_sortable == 'true' && $horizontal_filters != 'true') { ?>
        <div class="<?php echo esc_attr($filters_id); ?>"
             data-color-scheme="<?php echo strtolower(esc_attr($filter_color)); ?>">
            <a href="#"
               data-sortable-label="<?php echo (!empty($nectar_options['portfolio-sortable-text'])) ? $nectar_options['portfolio-sortable-text'] : 'Sort Portfolio'; ?>"
               id="sort-portfolio"><span><?php echo (!empty($nectar_options['portfolio-sortable-text'])) ? wp_kses_post($nectar_options['portfolio-sortable-text']) : esc_html__('Sort Portfolio', 'salient'); ?></span>
    ...
    if($project_style == '6' && $span_num == 'elastic-portfolio-item') echo 'spaced'; ?>">
        ...
        <span class="portfolio-loading <?php echo esc_attr($default_loader_class); ?> <?php echo (!empty($nectar_options['loading-image-animation']) && !empty($nectar_options['loading-image'])) ? $nectar_options['loading-image-animation'] : null; ?>">  <?php echo $default_loader; // WPCS: XSS ok.
            ?> </span>
        ...
        <div class="row portfolio-items <?php if($masonry_layout == 'true') echo 'masonry-items'; else {
            echo 'no-masonry';
        } ?> <?php if($layout == 'constrained_fullwidth') echo ' fullwidth-constrained ';
        echo esc_attr($infinite_scroll_class); ?> <?php echo esc_attr($constrain_col_class); ?>" <?php if($layout != 'fullwidth') echo 'data-rcp="' . esc_attr($remove_column_padding) . '"'; ?>
             data-masonry-type="<?php echo esc_attr($masonry_sizing_type); ?>"
             data-ps="<?php echo esc_attr($project_style); ?>"
             data-starting-filter="<?php echo esc_attr($starting_category); ?>"
             data-gutter="<?php echo esc_attr($item_spacing); ?>"
             data-categories-to-show="<?php echo esc_attr($category); ?>"
             data-bypass-cropping="<?php echo esc_attr($bypass_image_cropping); ?>"
             data-lightbox-only="<?php echo esc_attr($lightbox_only); ?>" data-col-num="<?php echo esc_attr($cols); ?>">
            <?php
            ...
            if(have_posts()) : while(have_posts()) : the_post(); ?>
                ...
                <div class="col <?php echo esc_attr($span_num) . ' ' . esc_attr($masonry_item_sizing) . esc_attr($customProjectClass); ?> element <?php echo esc_attr($project_cats); ?>"
                     data-project-cat="<?php echo esc_attr($project_cats); ?>" <?php if(!empty($project_accent_color)) {
                    echo 'data-project-color="' . esc_attr($project_accent_color) . '"';
                } else {
                    echo 'data-default-color="true"';
                } ?> data-title-color="<?php echo esc_attr($project_title_color); ?>"
                     data-subtitle-color="<?php echo esc_attr($project_subtitle_color); ?>">
                    ...
                    <div class="inner-wrap animated" data-animation="<?php echo esc_attr($load_in_animation); ?>">
                        ...
                        <div class="work-item style-1"
                             data-custom-content="<?php echo esc_attr($using_custom_content); ?>">
                                        ...
                                        <?php } else {
                                            ...
                                            if(!empty($video_embed) || !empty($video_m4v)) {
                                                ...
                                                if(!empty($custom_project_link) && strlen($custom_project_link) > 3) { ?>
                                                    <a href="<?php echo esc_url($the_project_link); ?>"></a>
                                                <?php } else { ?>
                                                    <a href="<?php echo esc_url($featured_image[0]); ?>" <?php if(!empty($project_image_caption)) echo ' title="' . wp_kses_post($project_image_caption) . '" '; ?>
                        ...
                        <?php } //project style 2
                            ...
                            <div class="work-item style-3"
                                 data-custom-content="<?php echo esc_attr($using_custom_content); ?>"
                                 data-text-align="<?php echo esc_attr($masonry_item_content_pos); ?>">
                                ...
                                <div class="work-info">
                                    ...
                                    <div class="vert-center">
                                        ...
                                        if(!empty($using_custom_content) && $using_custom_content == 'on') {
                                            ...
                                            <?php if(!empty($project_excerpt)) {
                                                echo '<p><span>' . wp_kses_post($project_excerpt) . '</span></p>';
                                            } elseif(!empty($nectar_options['portfolio_date']) && $nectar_options['portfolio_date'] == 1) echo '<p><span>' . get_the_date() . '</span></p>'; ?>
                                            <h3><?php echo get_the_title(); ?></h3>

                                            <svg class="next-arrow" xmlns="http://www.w3.org/2000/svg"
                                                 xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 39 12">
                                                <line class="top" x1="23" y1="-0.5" x2="29.5" y2="6.5"
                                                      stroke="#ffffff;"/>
                                                <line class="bottom" x1="23" y1="12.5" x2="29.5" y2="5.5"
                                                      stroke="#ffffff;"/>
                                            </svg><span class="line"></span></span>
...
function nectar_blog_processing($atts, $content = null)
{
    ...
    <div class="row">
        ...
        if($layout == 'std-blog-sidebar' || $layout == 'masonry-blog-sidebar') {
            ...
            if($layout == 'masonry-blog-full-screen-width' && $blog_masonry_style == 'auto_meta_overlaid_spaced' || $layout == 'masonry-blog-full-screen-width' && $blog_masonry_style == 'meta_overlaid') {
    ...
    <?php if($layout == 'masonry-blog-full-screen-width') {
    echo '</div>';
} ?>
...
function nectar_recent_posts($atts, $content = null)
{
    ...
    if($style != 'slider' && $style != 'slider_multiple_visible' && $style != 'single_large_featured' && $style != 'multiple_large_featured') {
        ...
        ?>
        <div class="row blog-recent columns-<?php echo esc_attr($columns); ?>"
             data-style="<?php echo esc_attr($modded_style); ?>"
             data-color-scheme="<?php echo esc_attr($color_scheme); ?>"
             data-remove-post-date="<?php echo esc_attr($blog_remove_post_date); ?>"
             data-remove-post-author="<?php echo esc_attr($blog_remove_post_author); ?>"
             data-remove-post-comment-number="<?php echo esc_attr($blog_remove_post_comment_number); ?>"
             data-remove-post-nectar-love="<?php echo esc_attr($blog_remove_post_nectar_love); ?>">
                ...
                <div <?php post_class('col' . ' ' . $col_num); ?> >
                    ...
                    if($style == 'default') {
                        ...
                        <div class="post-header">
                            ...
                            <span class="meta-author"><?php the_author_posts_link(); ?> </span> <span
                                    class="meta-category"> | <?php the_category(', '); ?> </span> <span
                    ...
                    <?php } else if($style == 'list_featured_first_row' || $style == 'list_featured_first_row_tall') { ?>
                        ...
                        if(has_post_thumbnail()) {
                            ...
                            echo '<a class="' . $list_featured_image_class . '" href="' . esc_url(get_permalink()) . '"></a>';
                        }
                        ?>
                        ...
                        <div <?php post_class('inner-wrap'); ?>>
                            ...
                            <a class="entire-meta-link" <?php echo $post_link_target; // WPCS: XSS ok. ?>
            ...
            <div class="nectar-recent-post-slide <?php if($bg_image_id == null) echo 'no-bg-img'; ?> post-ref-<?php echo esc_attr($i); ?>">
                ...
                <div class="row-bg using-image" data-parallax-speed="fast">
                    <div class="nectar-recent-post-bg"
                         style=" <?php if(!empty($bg_color)) { ?> background-color: <?php echo esc_attr($bg_color);?>; <?php } ?> background-image: url(<?php echo esc_url($featured_img); ?>);"></div>
                </div>
                ...
                <h2 class="post-ref-<?php echo esc_attr($i); ?>"><a href=" <?php echo esc_url(get_permalink()); ?>"
                                                                    class="full-slide-link"> <?php echo the_title(); ?> </a>
                </h2>
                ...
                ?>
                <a class="nectar-button large regular <?php echo esc_attr($button_color) . esc_attr($regular_btn_class); ?> has-icon"
                   href="<?php echo esc_url(get_permalink()); ?>" data-color-override="false"
                   data-hover-color-override="false"
                   data-hover-text-color-override="#fff"><span><?php echo esc_html__('Read More', 'salient'); ?></span>
        ...
        if($recent_posts_query->have_posts()) : while($recent_posts_query->have_posts()) : $recent_posts_query->the_post();
            ...
            <div class="nectar-recent-post-slide <?php if($bg_image_id == null) echo 'no-bg-img'; ?> <?php if($i == 0) echo 'active'; ?> post-ref-<?php echo esc_attr($i); ?>">
                ...
                <a class="nectar-button large regular <?php echo esc_attr($button_color) . esc_attr($regular_btn_class); ?> has-icon"
                   href="<?php echo esc_url(get_permalink()); ?>" data-color-override="false"
                   data-hover-color-override="false"
                   data-hover-text-color-override="#fff"><span><?php echo esc_html__('Read Article', 'salient'); ?> </span><i
        ...
        if($recent_posts_query->have_posts()) : while($recent_posts_query->have_posts()) : $recent_posts_query->the_post();
            ...
            <div class="nectar-recent-post-slide <?php if($bg_image_id == null) echo 'no-bg-img'; ?> post-ref-<?php echo esc_attr($i); ?>">
                ...
                <div class="nectar-recent-post-bg-blur"
                     style=" <?php if(!empty($bg_color)) { ?> background-color: <?php echo esc_attr($bg_color);?>; <?php } ?> background-image: url(<?php echo esc_url($featured_img); ?>);"></div>
                ...
                <h3 class="post-ref-<?php echo esc_attr($i); ?>"><a href=" <?php echo esc_url(get_permalink()); ?>"
                                                                    class="full-slide-link"> <?php echo the_title(); ?> </a>
                </h3>
                ...
                <?php if(!empty($nectar_options['theme-skin']) && $nectar_options['theme-skin'] == 'material') { ?>
                    <a class="nectar-button large regular  <?php echo esc_attr($button_color) . esc_attr($regular_btn_class); ?>"
                       href="<?php echo esc_url(get_permalink()); ?>" data-color-override="false"
                       data-hover-color-override="false"
                       data-hover-text-color-override="#fff"><span><?php echo esc_html__('Read Article', 'salient'); ?> </span></a>
                <?php } else { ?>
                    <a class="nectar-button large regular  <?php echo esc_attr($button_color) . esc_attr($regular_btn_class); ?> has-icon"
                       href="<?php echo esc_url(get_permalink()); ?>" data-color-override="false"
                       data-hover-color-override="false"
