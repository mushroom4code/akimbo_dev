    ...
    $(document).ready( function () {
        ...
        if ( $( the_lmp_js_data.products ).length > 0 ) {
            ...
            if ( lmp_loading_style != 'none' ) {
                ...
                /// Enterego(V.Mikhev) fix for page where not possible scrolling page
                $(document).ready(function () {
                    var listItems = $(".products").children();
                    var count_prod_in_page = listItems.length;
                    if(count_prod_in_page <5){
                        load_next_page();
                    }
