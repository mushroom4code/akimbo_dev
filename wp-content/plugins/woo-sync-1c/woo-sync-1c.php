<?php
/**
 *Plugin Name: WooCommerce and 1C:Enterprise Data Exchange
 * Author URI: http://enterego.ru
 *Version: 1.00
...
define('WC1C_DATA_DIR', "{$upload_dir['basedir']}/woo-sync-1c/");
...
function wc1c_activate() {
    ...
    wc1c_options::wc1c_generate_options();
