...
/**
* Traits Tn_Ved_Codes for simple products
*
...
trait YFYM_T_Simple_Get_Tn_Ved_Codes {
	public function get_tn_ved_codes($tag_name = 'tn-ved-codes', $result_xml = '') {
		...
		$result_xml = apply_filters('y4ym_f_simple_tag_tn_ved_code', $result_xml, array('product' => $product), $this->get_feed_id());
		return $result_xml;
	}
}
?>